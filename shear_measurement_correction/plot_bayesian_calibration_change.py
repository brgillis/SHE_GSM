...
""" @file /disk2/brg/git/SHE_sim/shear_measurement_correction/plot_bayesian_calibration_change.py
...
def main(argv):
    ...
    for calibration_set_size in ("1e4","1e6"):
        ...
        results_dir = "calibration_results_" + calibration_set_size + "_bayesian"
        ...
        for m_tag, measured_label in (("m", "Measured"),
            ...
            figname = (measured_label.lower() + "_" + calibration_set_size + "_"
                       + "bayesian_calibration." + file_format)
            if file_format == "eps":
