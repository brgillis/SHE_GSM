...
def main(argv):
    ...
    for calibration_set_size in ("1e4", "1e6"):
        ...
        for m in test_ms:
            for c in test_cs:
                ...
                if bayesian:
                    ...
                    filename_1 = join(results_dir_b, "calibration_results_bayesian_m_" +
                                      str(m) + "_c_" + str(c) + ".bin")
        ...
        yticks = [lim_factor * 0.06, lim_factor * 0.07, lim_factor * 0.08,
                  lim_factor * 0.09, lim_factor * 0.10, lim_factor * 0.11, ]
            ...
            for c in test_cs:
                ...
                if not bayesian:
                    ...
                    ax.annotate("", xytext=(res["cp_sigma"], res["mp_sigma"]),
                                xy=((res["cp_sigma"] + res["cpp_sigma"]) / 2,
                                    (res["mp_sigma"] + res["mpp_sigma"]) / 2),
